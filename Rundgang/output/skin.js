...
// Generated Sa. Apr 16 15:56:50 2022
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._gang_2_treppe.onclick=function () {
			...
			me._current_selection_2.ggParameter.rx=467;me._current_selection_2.ggParameter.ry=217;
			...
			me._orientierung_2.ggParameter.rx=467;me._orientierung_2.ggParameter.ry=217;
		...
		this._room_2_d.onclick=function () {
			me._current_selection_2.style[domTransition]='none';
			me._current_selection_2.ggParameter.rx=537;me._current_selection_2.ggParameter.ry=149;
			me._current_selection_2.style[domTransform]=parameterToTransform(me._current_selection_2.ggParameter);
			me._orientierung_2.style[domTransition]='none';
			me._orientierung_2.ggParameter.rx=537;me._orientierung_2.ggParameter.ry=149;
			me._orientierung_2.style[domTransform]=parameterToTransform(me._orientierung_2.ggParameter);
		...
		this._room_2_08.onclick=function () {
			me._current_selection_2.style[domTransition]='none';
			me._current_selection_2.ggParameter.rx=274;me._current_selection_2.ggParameter.ry=290;
			me._current_selection_2.style[domTransform]=parameterToTransform(me._current_selection_2.ggParameter);
			me._orientierung_2.style[domTransition]='none';
			me._orientierung_2.ggParameter.rx=274;me._orientierung_2.ggParameter.ry=290;
			me._orientierung_2.style[domTransform]=parameterToTransform(me._orientierung_2.ggParameter);
		...
		this._room_2_14.onclick=function () {
			me._current_selection_2.style[domTransition]='none';
			me._current_selection_2.ggParameter.rx=947;me._current_selection_2.ggParameter.ry=292;
			me._current_selection_2.style[domTransform]=parameterToTransform(me._current_selection_2.ggParameter);
			me._orientierung_2.style[domTransition]='none';
			me._orientierung_2.ggParameter.rx=947;me._orientierung_2.ggParameter.ry=292;
			me._orientierung_2.style[domTransform]=parameterToTransform(me._orientierung_2.ggParameter);
		...
		this._room_2_13.onclick=function () {
			me._current_selection_2.style[domTransition]='none';
			me._current_selection_2.ggParameter.rx=793;me._current_selection_2.ggParameter.ry=291;
			me._current_selection_2.style[domTransform]=parameterToTransform(me._current_selection_2.ggParameter);
			me._orientierung_2.style[domTransition]='none';
			me._orientierung_2.ggParameter.rx=793;me._orientierung_2.ggParameter.ry=291;
			me._orientierung_2.style[domTransform]=parameterToTransform(me._orientierung_2.ggParameter);
		...
		this._room_2_07.onclick=function () {
			me._current_selection_2.style[domTransition]='none';
			me._current_selection_2.ggParameter.rx=155;me._current_selection_2.ggParameter.ry=288;
			me._current_selection_2.style[domTransform]=parameterToTransform(me._current_selection_2.ggParameter);
			me._orientierung_2.style[domTransition]='none';
			me._orientierung_2.ggParameter.rx=155;me._orientierung_2.ggParameter.ry=288;
			me._orientierung_2.style[domTransform]=parameterToTransform(me._orientierung_2.ggParameter);
		...
		this._room_0_24.onclick=function () {
			me._current_selection_e.style[domTransition]='none';
			me._current_selection_e.ggParameter.rx=576;me._current_selection_e.ggParameter.ry=235;
			me._current_selection_e.style[domTransform]=parameterToTransform(me._current_selection_e.ggParameter);
			me._orientierung_e.style[domTransition]='none';
			me._orientierung_e.ggParameter.rx=576;me._orientierung_e.ggParameter.ry=235;
			me._orientierung_e.style[domTransform]=parameterToTransform(me._orientierung_e.ggParameter);
		...
		this._gang_u_10.onclick=function () {
			...
			me._current_selection_u.ggParameter.rx=356;me._current_selection_u.ggParameter.ry=174;
			...
			me._orientierung_u.ggParameter.rx=356;me._orientierung_u.ggParameter.ry=174;
		...
		this._gang_u_21.onclick=function () {
			me._current_selection_u.style[domTransition]='none';
			me._current_selection_u.ggParameter.rx=560;me._current_selection_u.ggParameter.ry=164;
			me._current_selection_u.style[domTransform]=parameterToTransform(me._current_selection_u.ggParameter);
			me._orientierung_u.style[domTransition]='none';
			me._orientierung_u.ggParameter.rx=560;me._orientierung_u.ggParameter.ry=164;
			me._orientierung_u.style[domTransform]=parameterToTransform(me._orientierung_u.ggParameter);
		...
		this._gang_u_27.onclick=function () {
			me._current_selection_u.style[domTransition]='none';
			me._current_selection_u.ggParameter.rx=839;me._current_selection_u.ggParameter.ry=168;
			me._current_selection_u.style[domTransform]=parameterToTransform(me._current_selection_u.ggParameter);
			me._orientierung_u.style[domTransition]='none';
			me._orientierung_u.ggParameter.rx=839;me._orientierung_u.ggParameter.ry=168;
			me._orientierung_u.style[domTransform]=parameterToTransform(me._orientierung_u.ggParameter);
		...
		this._robotik.onclick=function () {
			me._current_selection_u.style[domTransition]='none';
			me._current_selection_u.ggParameter.rx=724;me._current_selection_u.ggParameter.ry=145;
			me._current_selection_u.style[domTransform]=parameterToTransform(me._current_selection_u.ggParameter);
			me._orientierung_u.style[domTransition]='none';
			me._orientierung_u.ggParameter.rx=724;me._orientierung_u.ggParameter.ry=145;
			me._orientierung_u.style[domTransform]=parameterToTransform(me._orientierung_u.ggParameter);
		...
		this._room_u_11.onclick=function () {
			me._current_selection_u.style[domTransition]='none';
			me._current_selection_u.ggParameter.rx=306;me._current_selection_u.ggParameter.ry=335;
			me._current_selection_u.style[domTransform]=parameterToTransform(me._current_selection_u.ggParameter);
			me._orientierung_u.style[domTransition]='none';
			me._orientierung_u.ggParameter.rx=306;me._orientierung_u.ggParameter.ry=335;
			me._orientierung_u.style[domTransform]=parameterToTransform(me._orientierung_u.ggParameter);
		...
		this._room_u_22.onclick=function () {
			me._current_selection_u.style[domTransition]='none';
			me._current_selection_u.ggParameter.rx=634;me._current_selection_u.ggParameter.ry=220;
			me._current_selection_u.style[domTransform]=parameterToTransform(me._current_selection_u.ggParameter);
			me._orientierung_u.style[domTransition]='none';
			me._orientierung_u.ggParameter.rx=634;me._orientierung_u.ggParameter.ry=220;
			me._orientierung_u.style[domTransform]=parameterToTransform(me._orientierung_u.ggParameter);
		...
		this._room_u_23.onclick=function () {
			me._current_selection_u.style[domTransition]='none';
			me._current_selection_u.ggParameter.rx=960;me._current_selection_u.ggParameter.ry=156;
			me._current_selection_u.style[domTransform]=parameterToTransform(me._current_selection_u.ggParameter);
			me._orientierung_u.style[domTransition]='none';
			me._orientierung_u.ggParameter.rx=960;me._orientierung_u.ggParameter.ry=156;
			me._orientierung_u.style[domTransform]=parameterToTransform(me._orientierung_u.ggParameter);
		...
		this._room_u_26.onclick=function () {
			me._current_selection_u.style[domTransition]='none';
			me._current_selection_u.ggParameter.rx=948;me._current_selection_u.ggParameter.ry=220;
			me._current_selection_u.style[domTransform]=parameterToTransform(me._current_selection_u.ggParameter);
			me._orientierung_u.style[domTransition]='none';
			me._orientierung_u.ggParameter.rx=948;me._orientierung_u.ggParameter.ry=220;
			me._orientierung_u.style[domTransform]=parameterToTransform(me._orientierung_u.ggParameter);
		...
		this._d_turnhalle.onclick=function () {
			...
			me._current_selection_d.ggParameter.rx=378;me._current_selection_d.ggParameter.ry=241;
			...
			me._orientierung_d.ggParameter.rx=378;me._orientierung_d.ggParameter.ry=241;
		...
		this._d_vorschule.onclick=function () {
			me._current_selection_d.style[domTransition]='none';
			me._current_selection_d.ggParameter.rx=410;me._current_selection_d.ggParameter.ry=403;
			me._current_selection_d.style[domTransform]=parameterToTransform(me._current_selection_d.ggParameter);
			me._orientierung_d.style[domTransition]='none';
			me._orientierung_d.ggParameter.rx=410;me._orientierung_d.ggParameter.ry=403;
			me._orientierung_d.style[domTransform]=parameterToTransform(me._orientierung_d.ggParameter);
		...
		this._d_haupteingang.onclick=function () {
			me._current_selection_d.style[domTransition]='none';
			me._current_selection_d.ggParameter.rx=497;me._current_selection_d.ggParameter.ry=375;
			me._current_selection_d.style[domTransform]=parameterToTransform(me._current_selection_d.ggParameter);
			me._orientierung_d.style[domTransition]='none';
			me._orientierung_d.ggParameter.rx=497;me._orientierung_d.ggParameter.ry=375;
			me._orientierung_d.style[domTransform]=parameterToTransform(me._orientierung_d.ggParameter);
		...
		this._d_pausenhof.onclick=function () {
			me._current_selection_d.style[domTransition]='none';
			me._current_selection_d.ggParameter.rx=631;me._current_selection_d.ggParameter.ry=369;
			me._current_selection_d.style[domTransform]=parameterToTransform(me._current_selection_d.ggParameter);
			me._orientierung_d.style[domTransition]='none';
			me._orientierung_d.ggParameter.rx=631;me._orientierung_d.ggParameter.ry=369;
			me._orientierung_d.style[domTransform]=parameterToTransform(me._orientierung_d.ggParameter);
		...
		this._d_roterplatz.onclick=function () {
			me._current_selection_d.style[domTransition]='none';
			me._current_selection_d.ggParameter.rx=707;me._current_selection_d.ggParameter.ry=286;
			me._current_selection_d.style[domTransform]=parameterToTransform(me._current_selection_d.ggParameter);
			me._orientierung_d.style[domTransition]='none';
			me._orientierung_d.ggParameter.rx=707;me._orientierung_d.ggParameter.ry=286;
			me._orientierung_d.style[domTransform]=parameterToTransform(me._orientierung_d.ggParameter);
		...
		this._d_schulwald.onclick=function () {
			me._current_selection_d.style[domTransition]='none';
			me._current_selection_d.ggParameter.rx=699;me._current_selection_d.ggParameter.ry=43;
			me._current_selection_d.style[domTransform]=parameterToTransform(me._current_selection_d.ggParameter);
			me._orientierung_d.style[domTransition]='none';
			me._orientierung_d.ggParameter.rx=699;me._orientierung_d.ggParameter.ry=43;
			me._orientierung_d.style[domTransform]=parameterToTransform(me._orientierung_d.ggParameter);
		...
		this._d_vorschulwald.onclick=function () {
			me._current_selection_d.style[domTransition]='none';
			me._current_selection_d.ggParameter.rx=628;me._current_selection_d.ggParameter.ry=56;
			me._current_selection_d.style[domTransform]=parameterToTransform(me._current_selection_d.ggParameter);
			me._orientierung_d.style[domTransition]='none';
			me._orientierung_d.ggParameter.rx=628;me._orientierung_d.ggParameter.ry=56;
			me._orientierung_d.style[domTransform]=parameterToTransform(me._orientierung_d.ggParameter);
		...
		this._button_help_2.ggVisible=false;
		...
		this._computer.appendChild(this._mapholder);
		...
		this._computer.appendChild(this._openmap);
		this.divSkin.appendChild(this._computer);
